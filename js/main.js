(function ($) {
    ...
    $.fn.customizeCanvas = function (options) {
        ...
        (function initParticles() {
            ...
            function Particle() {
                this.x = Math.random() * window.innerWidth,
                    ...
                    this.vx = -1 + settings.horizontalSpeed * Math.random(),
                    this.vy = -1 + settings.verticalSpeed * Math.random(),
                ...
                if (minDist >= dist) {
                    if (JSON.stringify(p1.color) != JSON.stringify(p2.color)) {
                        ...
                        gradient.addColorStop("0", "rgb(" + p1.color.r + ", " + p1.color.g + ", " + p1.color.b + ")"),
                            ...
                            ctx.strokeStyle = gradient, ctx.moveTo(p1.x, p1.y),
            ...
            function init() {
                ...
                ctx = document.getElementById('space').getContext("2d"),
                    ...
                    particles = [],
                    particleRadius = settings.particleRadius, minDist = settings.minConnectDistance, velocity = 1, colors = [
                        dotFill1 = settings.dotFill1,
                        dotFill2 = settings.dotFill2,
                        dotFill3 = settings.dotFill3,
                    ];
